...
app.use(express.static(path.join(__dirname + '../../../spa/TableEditor/build')));
app.use(express.static(path.join(__dirname + '../../../spa/LayoutEditor_Boilerplate/layout_frontend/build')));
